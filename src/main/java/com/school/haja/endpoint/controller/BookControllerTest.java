...
// @Import(GlobalExceptionHandler.class) // pour tester les 404
...
//    Book request = new Book(null, "The Hobbit", "9780547928227", 310, 24.99,
// Instant.parse("1937-09-21T00:00:00Z"));
//    Book response = new Book(BOOK_ID, "The Hobbit", "9780547928227", 310, 24.99,
// Instant.parse("1937-09-21T00:00:00Z"));
//
...
//    Book book = new Book(BOOK_ID, "The Hobbit", "9780547928227", 310, 24.99,
// Instant.parse("1937-09-21T00:00:00Z"));
...
//    when(bookService.getById(BOOK_ID)).thenThrow(new EntityNotFoundException("Book not found: " +
// BOOK_ID));
//
//    mockMvc
//        .perform(get("/books/{id}", BOOK_ID))
...
//    Book request = new Book(null, "Updated title", "9780547928227", 310, 29.99,
// Instant.parse("1937-09-21T00:00:00Z"));
//    Book response = new Book(BOOK_ID, "Updated title", "9780547928227", 310, 29.99,
// Instant.parse("1937-09-21T00:00:00Z"));
//
